...
public class StreamApiTest {
	...
	@Test
	@DisplayName("#2. Obtain a list of product with category = \"Books\" and price > 100 (using Predicate chaining for filter)")
	...
	@Test
	@DisplayName("#3. Obtain a list of product with category = \"Books\" and price > 100 (using BiPredicate for filter)")
	...
	@Test
	@DisplayName("#4. Obtain a list of order with product category = \"Baby\"")
	...
	@Test
	@DisplayName("#5. Obtain a list of product with category = “Toys” and then apply 10% discount\"")
	...
	@Test
	@DisplayName("#6. Obtain a list of products ordered by customer of tier 2 between 01-Feb-2021 and 01-Apr-2021")
	...
	@Test
	@DisplayName("#7. Get the 3 cheapest products of \"Books\" category")
...
//                              .findFirst();
	...
	@Test
	@DisplayName("#8. Get the 3 most recent placed order")
	...
	@Test
	@DisplayName("#9. Get a list of products which was ordered on 15-Mar-2021")
	...
	@Test
	@DisplayName("#10. Calculate the total lump of all orders placed in Feb 2021")
	...
	@Test
	@DisplayName("#11. Calculate the total lump of all orders placed in Feb 2021 (using reduce with BiFunction)")
	...
	@Test
	@DisplayName("#12. Calculate the average price of all orders placed on 15-Mar-2021")
	...
	@Test
	@DisplayName("#13. Obtain statistics summary of all products belong to \"Books\" category")
	...
	@Test
	@DisplayName("#14. Obtain a mapping of order id and the order's product count")
	...
	@Test
	@DisplayName("#15. Obtain a data map of customer and list of orders")
	...
	@Test
	@DisplayName("#16. Obtain a data map of customer_id and list of order_id(s)")
	...
	@Test
	@DisplayName("#17. Obtain a data map with order and its total price")
	...
	@Test
	@DisplayName("#18. Obtain a data map with order and its total price (using reduce)")
	...
	@Test
	@DisplayName("#19. Obtain a data map of product name by category")
	...
	@Test
	@DisplayName("#20. Get the most expensive product per category")
	void exercise15() {
		long startTime = System.currentTimeMillis();
...
//		});
	...
	@Test
	@DisplayName("#21. Get the most expensive product (by name) per category")
	void exercise15a() {
		long startTime = System.currentTimeMillis();
